        ...
        <tr>
            <td height="100px" style="background:#00111b;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            <td align="center" style="font-family:sonsie; font-size:36px;">Videos</td>
                        </tr>
                    </tbody>
                </table>
            </td>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script></td>
        ...
        <tr>
            <td valign="top">
                ...
                <?php
                if ($queryRecentVideoPosts->num_rows > 0) {
                    echo '<table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody>';
                    while ($article = $queryRecentVideoPosts->fetch_assoc()) {
                        echo '<tr><td colspan="4" style="font-size:40px; font-weight:bold; padding-left:2px;">' . $article["title"] . '</td></tr>';
                        echo '<tr><td rowspan="3" width="267px"><a href="../blog/read.php?article=' . $article["id"] . '"><div style="width:267px; height:150px; background-image:url(';
                        ...
                        echo '<tr><td colspan="2" valign="top" style="padding-left:2px;">' . $article["snipet"] . '</td></tr>';
