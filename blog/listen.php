...
<script src="../videojs/videojs.watermark.dev.js"></script>
<script>
...
<?php
    ...
    while ($article = $queryReadPost2->fetch_assoc()) {
        ...
        echo '<tr><td colspan="2">';
            ...
            echo "data-setup='{}'";
            echo'><source src="http://sorensenmedia.s3.amazonaws.com/hosted/club0303/02-00_intro.mp4" type="video/mp4"></video>';
            echo '</td></tr>';
